...
export default function Home() {
  ...
  return (
    <>
      {(loading && <div className="text-7xl text-center">Loading...</div>) ||
        (error && (
          <>
            <ErrorPage error={error} />
          </>
        )) || (
          <div className="min-h-fit bg-gradient-to-br flex flex-col justify-between gap-20 from-orange-100 from-10% via-white to-orange-300 overflow-hidden">
